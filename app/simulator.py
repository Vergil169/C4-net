...
class NetworkSimulator:
    def __init__(self) -> None:
        ...
        self.links: dict[str, Link] = {
            ...
            "lnk-beijing-shanghai-private": Link(id="lnk-beijing-shanghai-private", source="beijing-campus", target="shanghai-cloud", domain="低时延专线", latency_ms=25, loss_percent=0.05, capacity_mbps=200, utilization_percent=26),
    ...
    def _policy_from_candidate(self, intent: BusinessIntent, path: CandidatePath) -> NetworkPolicy:
        qos_class = "EF-REALTIME" if intent.service in {"视频会议", "语音", "实时业务", "瑙嗛浼氳", "璇煶", "瀹炴椂涓氬姟"} else "AF-BUSINESS"
    ...
    def _baseline(self, link_id: str) -> Link:
        baseline = {
            ...
            "lnk-beijing-shanghai-private": Link(id=link_id, source="beijing-campus", target="shanghai-cloud", domain="低时延专线", latency_ms=25, loss_percent=0.05, capacity_mbps=200, utilization_percent=26),
